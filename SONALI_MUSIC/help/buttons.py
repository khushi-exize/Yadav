...
class BUTTONS(object):
    ...
    PBUTTON = [
        [
            InlineKeyboardButton("- ᴇxɪᴢᴇ_ᴍᴜꜱɪᴄ (ɴᴏ ᴀᴅꜱ)› ᴏᴘ 𝃵⎯̽⇢🎫", url="t.me/ExizeXd")
        ],
        [
    ...
    ABUTTON = [
        [
            InlineKeyboardButton("⌯ sυᴘᴘσʀᴛ ⌯", url="https://t.me/exizemusicsupport"),
            InlineKeyboardButton("⌯ υᴘᴅᴧᴛєs ⌯", url="https://t.me/exizemusicupdate"),
        ],
        [
